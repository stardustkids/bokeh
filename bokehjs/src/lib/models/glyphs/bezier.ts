...
import {$project_xy} from "core/util/projections"
...
export class BezierView extends GlyphView {
  ...
  protected _project_data(): void {
    $project_xy(this._x0, this._y0)
    $project_xy(this._x1, this._y1)
  }
...
export class Bezier extends Glyph {
  ...
  static init_Bezier(): void {
    ...
    this.define<Bezier.Props>({
      ...
      cx0: [ p.CoordinateSpec, {field: "cx0"} ],
      cy0: [ p.CoordinateSpec, {field: "cy0"} ],
      cx1: [ p.CoordinateSpec, {field: "cx1"} ],
      cy1: [ p.CoordinateSpec, {field: "cy1"} ],
    })
